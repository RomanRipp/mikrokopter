 ...
 */
void EarthCoords::setHome(double lat, double lon, double alt, double roll, double pitch, double yaw){
	homeset = true;
	lathom=lat;
	lonhom=lon;
	althom=alt;
...
void EarthCoords::getHome(double&lat, double&lon, double&alt, double&roll,double&pitch,double&yaw){
	if (homeset){
		lat = lathom;
		lon=lonhom;
		alt=althom;
...
void EarthCoords::getLocalCords(double lat, double lon, double alt, double& xout, double& yout, double& zout){
	double m,n;
...
void EarthCoords::getLocalAttit(double roll, double pitch, double yaw, double& rout,double& pout,double& yout){
	rout = roll - rollhom;
	pout = pitch - pitchhom;
	yout = yaw - yawhom;
}
