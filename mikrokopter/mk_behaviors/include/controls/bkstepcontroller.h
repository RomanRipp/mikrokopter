#ifndef MK_BEHAVIORS_BkStepController_H
#define MK_BEHAVIORS_BkStepController_H

#include <armadillo>
#include "mk_msgs/motorCommands.h"
#include "geometry_msgs/Pose.h"

class BkStepController{
	public:
		/*
		/Constructor
		*/
		 ...
		 */
		void setForces(double m, double f);
		/**
...
#endif /*MK_BEHAVIORS_BkStepController_H*/
