...
(cl:defmethod cl:initialize-instance :after ((m <motorCommands>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motorCommands)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mk_msgs-msg:<motorCommands> is deprecated: use mk_msgs-msg:motorCommands instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <motorCommands>))
...
(cl:defmethod pitch-val ((m <motorCommands>))
...
(cl:defmethod roll-val ((m <motorCommands>))
...
(cl:defmethod yaw-val ((m <motorCommands>))
...
(cl:defmethod throttle-val ((m <motorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mk_msgs-msg:throttle-val is deprecated.  Use mk_msgs-msg:throttle instead.")
  (throttle m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<motorCommands>)))
  ...
  "fab271cfc8e36c109ccbcbfe60210ac3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'motorCommands)))
  "Returns md5sum for a message object of type 'motorCommands"
  "fab271cfc8e36c109ccbcbfe60210ac3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<motorCommands>)))
  ...
  (cl:format cl:nil "Header header~%~%# between -pi to +pi~%float64 pitch~%float64 roll~%float64 yaw~%~%# between 0 to 255~%int64 throttle~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'motorCommands)))
  "Returns full string definition for message of type 'motorCommands"
  (cl:format cl:nil "Header header~%~%# between -pi to +pi~%float64 pitch~%float64 roll~%float64 yaw~%~%# between 0 to 255~%int64 throttle~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
