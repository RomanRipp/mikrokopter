...
%
% Converts the CharacterArray String into a CellStringArray.
%
% Each Line of String (separated by NewLine) is returned
%  in a single element of the CellStringArray.
%
%---------------------------------------------------------
