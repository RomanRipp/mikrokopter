function fig = list(varargin)

% LIST  Opens DialogWindow to Display a List
%
%  FigureHandle = LIST( FigureName , Titel , Text , String , [ NRow NCol ] );
%
%
...
HClose = uicontrol('Parent',fig, ...
	'Units','pixels', ...
	'BackgroundColor',UIColor, ...
	'Position',[ (FigPos(3)-ww(2))/2 1/4*UIHeight  ww(4)  UIHeight], ...
	'String'     , 'Close'      , ...
        'FontUnits'  , FontUnits    , ...
        'FontSize'   , FontSize     , ...
