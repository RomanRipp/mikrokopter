...
% BROWSER  15. Nov. 2005 Creates and Manages a BrowserFigure
%
...
case 'NEW'
 ...
 % DefaultHelpText created by function INTRO below
   ...
   HHelpFrame = uicontrol('parent'          , fig           , ...
      ...
      FontName    = { 'arrial'  'courier' };
      FontName    = FontName{ 1 + strcmp(upper(computer),'PCWIN') } ;
