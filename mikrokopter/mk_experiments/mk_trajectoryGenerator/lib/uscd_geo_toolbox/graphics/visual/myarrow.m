function  [xx,yy]= myarrow(xx0,yy0,tip,head,base,width);

% MYARROW    Calculates ArrowHead for Lines
%
%   [ XX , YY ] = MYARROW( XX0 , YY0 );
% 
...
%        XX , YY  ...  [ 3 by N ] ([ Tail1 ; Pike(End) ; Tail2 ]) )
%
%    Use:
%
...
%
%
%   [ XX , YY ] = MYARROW( ... , TipAngle , HeadLength );
%
